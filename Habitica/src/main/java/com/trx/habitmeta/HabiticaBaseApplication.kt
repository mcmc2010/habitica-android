...
abstract class HabiticaBaseApplication : Application(), Application.ActivityLifecycleCallbacks {
    ...
    override fun onCreate() {
        ...
        _deviceUID = this.getDeviceUID()


        Log.i("habitmeta", "Device UID:" + _deviceUID + ", User ID: " + lazyApiHelper.hostConfig.userID)
        if (!BuildConfig.DEBUG) {
            ...
            Analytics.setUserID(_deviceUID)
    ...
    public fun hashSHA256(input: String): String {
    ...
    private fun getDeviceUID(): String {
        try {
            ...
            Log.w("habitmeta", "Failed to get Android ID", e)
            return ""
        }
    }
