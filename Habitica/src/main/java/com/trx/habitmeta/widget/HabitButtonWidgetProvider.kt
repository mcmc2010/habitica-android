...
class HabitButtonWidgetProvider : BaseWidgetProvider() {
    ...
    companion object {
        const val HABIT_ACTION = "com.trx.habitmeta.HABIT_ACTION"
        const val TASK_ID = "com.trx.habitmeta.TASK_ID_ITEM"
        const val TASK_DIRECTION = "com.trx.habitmeta.TASK_DIRECTION"
    }
}
