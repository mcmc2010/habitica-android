package com.trx.habitmeta.common.api
    ...
    constructor(sharedPreferences: SharedPreferences, keyHelper: KeyHelper?, context: Context) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            if (!address.isNullOrEmpty()) {
                ...
                this.address = context.getString(com.trx.habitmeta.common.R.string.base_url)
            }
        }
        this.userID = sharedPreferences.getString(context.getString(com.trx.habitmeta.common.R.string.SP_userID), null) ?: ""
